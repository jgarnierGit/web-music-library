...
var createModule = (() => {
  ...
  return (
    function (moduleArg = {}) {
      ...
      ["_add_audio_data", "_memory", "___indirect_function_table", "___emscripten_embedded_file_data", "onRuntimeInitialized"].forEach((prop) => {
      ...
      var _add_audio_data = Module['_add_audio_data'] = createExportWrapper('add_audio_data', 2);
      ...
      var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 3857804;
